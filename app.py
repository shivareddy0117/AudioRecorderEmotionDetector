...
description = "This model is a text-detector for AI-text generated by Vicuna-7B. It is fine-tuned using adversarial training based on the pretrain version of roberta-large."
